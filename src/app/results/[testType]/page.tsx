          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-gray-800">{Math.round((questions.filter((q: any) => q.category === 'mathematical' && answers[q.id] === q.correct).length / questions.filter((q: any) => q.category === 'mathematical').length) * 100) || 0}%</span>
              </div>
              <div className="flex justify-between items-center">
    ...
    <>
      ...
      <div className="pt-2 px-4 sm:px-6 lg:px-8 flex-grow">
        ...
        <Header onLogoClick={undefined} />
            ...
            {(testType === 'emotional-intelligence' || testType === 'personality' || testType === 'optical-illusion' || testType === 'trivia' || testType === 'memory' || testType === 'math' || testType === 'color-blindness' || testType === 'reaction-time' || testType === 'stress-test' || testType === 'iq-test' || testType === 'time-management-test') && (
              <div className="mb-2">
            ...
            {/* Results Content */}
            <div className={`mt-2 ${(testType === 'emotional-intelligence' || testType === 'personality' || testType === 'optical-illusion' || testType === 'trivia' || testType === 'memory' || testType === 'math' || testType === 'color-blindness' || testType === 'reaction-time' || testType === 'stress-test' || testType === 'iq-test') ? 'mb-2' : ''}`}>
