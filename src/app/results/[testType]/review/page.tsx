...
Visit https://testyourself.com for more tests!`
      ...
      case 'world-geography-test':
        ...
        content += `World Geography Challenge Results
Date: ${timestamp}
...
Visit https://testyourself.com for more tests!`
  ...
  const getSEOContent = () => {
    ...
    switch (testType) {
      ...
      case 'world-geography-test':
        return {
          title: 'World Geography Challenge Review - Question Analysis | TestYourself',
          description: 'Review your world geography challenge questions and answers! See detailed analysis of your global knowledge across countries, capitals, landmarks, flags, and physical geography.',
          keywords: 'world geography test review, geography challenge review, countries capitals review, landmarks review, flags review, physical geography review, global knowledge analysis',
          ogTitle: 'World Geography Challenge Review - Question Analysis',
          ogDescription: 'Review your world geography challenge questions and answers with detailed analysis of your global knowledge and geography skills.',
              ...
              {testType === 'world-geography-test' && questions.length > 0 && (
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-3 mt-2">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4 text-center">
                    World Geography Challenge Review
                  </h3>
