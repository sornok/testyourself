      ...
      <div className="min-h-screen flex flex-col">
        <div className="pt-2 px-4 sm:px-6 lg:px-8 flex-grow">
          <div className="max-w-6xl mx-auto overflow-x-hidden">
            ...
            {/* Action Buttons - Exclude Emotional Intelligence, Personality, Optical Illusion, Trivia, Memory, Math, Color Blindness, Reaction Time, and Stress Test as they have their own buttons at top */}
            {testType !== 'emotional-intelligence' && testType !== 'personality' && testType !== 'optical-illusion' && testType !== 'trivia' && testType !== 'memory' && testType !== 'math' && testType !== 'color-blindness' && testType !== 'reaction-time' && testType !== 'stress-test' && (
