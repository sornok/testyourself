...
Visit https://testyourself.com for more tests!`
  ...
  const getSEOContent = () => {
    ...
    switch (testType) {
      ...
      case 'world-geography-test':
        return {
          title: 'Share World Geography Challenge Results | TestYourself',
          description: 'Share your world geography challenge results with friends and family. Let them discover their global knowledge of countries, capitals, landmarks, and physical geography with our free geography test!',
          keywords: 'share world geography test results, share geography challenge results, global knowledge sharing, countries capitals sharing, landmarks sharing, free geography test',
          ogTitle: 'Share World Geography Challenge Results',
          ogDescription: 'Share your world geography challenge results with friends and family. Let them discover their global knowledge and geography skills!',
      ...
      <div className="min-h-screen flex flex-col">
        <div className="pt-2 px-4 sm:px-6 lg:px-8 flex-grow">
          <div className="max-w-6xl mx-auto overflow-x-hidden">
            ...
            {/* Action Buttons - For Emotional Intelligence, Personality, Optical Illusion, Trivia, Memory, Math, Color Blindness, Reaction Time, Stress Test, and IQ Tests */}
            ...
            {/* Action Buttons - Exclude Emotional Intelligence, Personality, Optical Illusion, Trivia, Memory, Math, Color Blindness, Reaction Time, Stress Test, and IQ Test as they have their own buttons at top */}
            {testType !== 'emotional-intelligence' && testType !== 'personality' && testType !== 'optical-illusion' && testType !== 'trivia' && testType !== 'memory' && testType !== 'math' && testType !== 'color-blindness' && testType !== 'reaction-time' && testType !== 'stress-test' && testType !== 'iq-test' && testType !== 'time-management-test' && testType !== 'spatial-reasoning-test' && testType !== 'world-geography-test' && (
