                ...
                "mainEntity": [
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "The Ishihara test is a color vision screening test that uses colored plates with numbers or patterns. It helps identify color vision deficiencies, particularly red-green color blindness, by testing your ability to distinguish colors."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Our color blindness test uses standard Ishihara plates and provides a comprehensive assessment. While it's effective for screening, it's not a substitute for professional eye examination. Consult an eye care professional for definitive diagnosis."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "This test primarily detects red-green color blindness (protanopia and deuteranopia) and blue-yellow color blindness (tritanopia). It can also identify total color blindness (monochromacy) in some cases."
                    }
                  },
                  {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "The test takes approximately 3-5 minutes to complete. It includes 15 Ishihara plates that you'll view and identify numbers or patterns within the colored circles."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can I take this test multiple times?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes, you can take the test multiple times. However, for accurate results, it's best to take it when you're well-rested and in good lighting conditions. Avoid taking it multiple times in quick succession."
                    }
                  }
                ]
              },
